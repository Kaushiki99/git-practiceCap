...
public class SortingString {
		...
		// Method to sort string array in alphabetical order and covert first half to upper case and next half to lower case
		...
		public static void main(String[] args) {
			...
			for(int i=0;i<size;i++) {
				...
				obj[i]=sc.next(); //here we take input of String objects
			}
			obj=sortStrings(obj);
